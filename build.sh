...
# Paths
KERNEL_DIR=`pwd`
REPACK_DIR="${HOME}/Android/Kernel/hC-N6-bricked-anykernel"
...
function make_kernel {
		...
		mv ${HOME}/Android/Kernel/hC-N6-bricked-anykernel/kernel/zImage-dtb ${HOME}/Android/Kernel/hC-N6-bricked-anykernel/kernel/zImage
}
